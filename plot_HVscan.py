...
#file_map.append(("/Users/artur/Work/LLR/HGCAL/Testbeam/data/may17/PED_RUN_0713_100517_1423.root","0/ plugged"))
'''
...
for fname,label,col in file_map:
    ...
    #tree.Draw("hg[0][][10] >>" + hname + "(100,0,1000)","roll[Iteration$] == 0",pOpt);
    #tree.Draw("hg[0][][9] >>" + hname,"roll[Iteration$] == 0",pOpt);
    tree.Draw("hg[0][][10] >>" + hname,"roll[Iteration$] == 0",pOpt);
    #tree.Draw("lg[0][][9] >>" + hname,"roll[Iteration$] == 0",pOpt);
    #tree.Draw("hg[0][][9] >>" + hname,"roll[Iteration$] == 0",pOpt);
